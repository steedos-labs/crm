...
| CRM-013 | 第三阶段 | 实现 `crm_products` 产品对象 | 待验收 | AI | 产品编码、分类、单位、标准价、状态等字段齐全 | `docs/project-management/sprints/phase-3-contracts.md` |
| CRM-014 | 第三阶段 | 实现 `crm_price_books` 价格表对象 | 待验收 | AI | 价格表基础字段、权限和列表视图齐全 | `docs/project-management/sprints/phase-3-contracts.md` |
| CRM-015 | 第三阶段 | 实现 `crm_quotes` 报价对象 | 待验收 | AI | 报价编号、商机、客户、状态、总额、有效期字段齐全 | `docs/project-management/sprints/phase-3-contracts.md` |
